...
def send_message():
    """
    This function handles WhatsApp message sending via API when a POST request is made.
    """
    ...
    response = requests.post(url, data=get_text_message_input(recipient, message), headers=headers)
